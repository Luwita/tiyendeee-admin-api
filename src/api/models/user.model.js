  ...
  formatedSingleData(user) {
    if (!user.is_deleted) {
      return {
        ...
        //   ? moment(user.places.home.timing).tz("Asia/Kolkata").format("hh:mm a")
        //   : "",
        // office_timing: user.places
        //   ? moment(user.places.office.timing).tz("Asia/Kolkata").format("hh:mm a")
        //   : "",
    ...
    data.forEach((item) => {
      ...
      selectableItems.push({
        ...
        home_timing: item.places
          ? moment(item.places.home.timing).tz("Asia/Kolkata").format("hh:mm a")
          : "",
