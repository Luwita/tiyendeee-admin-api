            ...
            if (item.adminId) {
                selectableItems.push({
                    ...
                    picture: this.isValidURL(item.picture) ?
                        item.picture : `${FULLBASEURL}` + item.picture,
                    document_licence: this.isValidURL(item.document_licence) ?
                        item.document_licence : `${FULLBASEURL}` + item.document_licence,
                    document_adhar_card: this.isValidURL(item.document_adhar_card) ?
                        item.document_adhar_card : `${FULLBASEURL}` + item.document_adhar_card,
                    document_police_vertification: this.isValidURL(
                            item.document_police_vertification
                        ) ?
                        item.document_police_vertification : `${FULLBASEURL}` + item.document_police_vertification,
