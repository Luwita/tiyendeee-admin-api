...
// constvalidate = require('express-validation');
const Validate = require('../../middlewares/validator');
const controller = require('../../controllers/auth.controller');
// const oAuthLogin = require('../../middlewares/auth').oAuth;
const { authValidation } = require('../../validations');

const { getAuth, deletes3Object } = require('../../middlewares/auth');
...
router
  .route('/')
  .get(getAuth('master.admin'), controller.authLists)
...
router
  .route('/:adminId/status')
/**
 *  update status
 * * */
  .patch(getAuth('manage.admin.profile.update', 'master.admin'), controller.status);
...
router
  ...
  .get(getAuth('manage.admin.profile', 'master.admin'), controller.get)
  /**
  * update the single location
  * */
  .patch(getAuth('manage.admin.profile.update', 'master.admin'), controller.update)
...
/**
  ...
  * */
  ...
  .delete(getAuth('master.admin'), deletes3Object, controller.remove);
